...
from ltest.geometry.symmetric_plate import SymmetricPlateGeometry as Geometry
from ltest.model.model import Model

class PlateModel(Geometry, Model):
    ...
    def __init__(self, s_i, g_i, g_o, b, d, soil, footing, column,
        ...
        Geometry.__init__(self, b, d, dstrata=dstrata, wt=wt,
    ...
    def _set_output_postcalc(self):
        ...
        for loc in self._output_location:
            self._output_point[loc] = self._g_o.addcurvepoint("node", plate_footing, (loc * self._b / 2,  -self._d))
