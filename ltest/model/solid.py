...
from ltest.geometry.solid import SymmetricSolidGeometry as SG
from ltest.geometry.solid import NonSymmetricSolidGeometry as NSG
...
class SymmetricSolidModel(SG, SolidModel, Model):
    ...
    interface : bool, dict, None, optional
        ...
        If None, only the column interface is activated. By
        default None.
